              ...
              <div className='tour__content'>
                ...
                <div className='tour__info'>
                  ...
                  <div className='tour__extra-details'>
                    ...
                    <span><i class="ri-groupline"></i>{maxGroupSize}</span> people
                  </div>
                  <h5>Description</h5>
                  <p>{desc}</p>
                </div>
                  ...
                  <h4>Reviews ({reviews?.length} reviews) </h4>
                    <Form onSubmit={submitHandler}>
                      ...
                      <div className='review__input'>
                        <input type="text" ref={reviewMsgRef} placeholder='share your thougts' required/>
                            ...
                            <div className='w-100'>
                              <div className='d-flex align-items-center justify-content-between'>
                                <div>
                                  <h5>Valennz</h5>
                                  <p>
                                    {new Date("01-29-2023").toLocaleDateString("en-US", options)}
                                  </p>
                                </div>
